...
- [x] The hero section of the routine details page should have a background color that is the same as the color of the routine card. This will make the page more visually appealing and consistent.
